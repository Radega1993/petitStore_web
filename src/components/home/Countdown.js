...
export const Countdown = ({ days = 0 ,hours = 0, minutes = 0, seconds = 0 }) => {
  ...
  return (
    <div className="rounded counter__bgcolor text-white shadow p-5 text-center">
      <p className="mb-0 font-weight-bold text-uppercase display-3"> Tiempo para el lanzamiento </p>
      <div className="row">
      ...
      <div className="mb-0 font-weight-bold text-uppercase display-3">{over ? "Time's up!" : ''}</div>
    </div>
  );
}
